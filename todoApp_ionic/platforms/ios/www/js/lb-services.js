...
var urlBase = "https://mortenbrudvik.herokuapp.com/api/";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Tasks.customer() instead.
        "::get::tasks::customer": {
          url: urlBase + "/tasks/:id/customer",
          method: "GET"
        },
    ...
    */
     ...
     * manipulating `Tasks` instances related to `Customer`.
     *
     ...
     */
         ...
         */
        R.tasks = function() {
          var TargetResource = $injector.get("Tasks");
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Tasks";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Tasks#customer
         * @methodOf lbServices.Tasks
         *
         * @description
         *
        ...
        R.customer = function() {
          ...
          var action = TargetResource["::get::tasks::customer"];
          return action.apply(R, arguments);
        };
